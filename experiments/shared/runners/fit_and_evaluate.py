...
computed from, exactly as _archive/docs_legacy/current_objectives.md and
experiments/shared/questions/split.py always specified. If fitting finds nothing
