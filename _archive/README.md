...
2. **The active code must not import from here.** Verified: nothing under
   `src/`, `evaluation/`, `experiments/shared/`, or `experiments/baseline/` imports
...
`experiments/shared/runners/run_end_to_end.py` or any current test target. Treat
